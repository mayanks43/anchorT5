...
if __name__ == "__main__":
    ...
    for idx in tqdm(range(len(sentences))):
        ...
        for pphrase in pphrases.get(doc_id.strip('"'), []):
            ...
            pphrase_support_sentence["sentence"]["id"] = "\"" + sentence["id"].strip('"') + "_" + str(pphrase_idx) + "\""
            pphrase_support_sentence["sentence"]["docId"] = "\"" + sentence["docId"].strip('"') + "_" + str(pphrase_idx) + "\""
