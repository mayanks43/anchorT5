...
OUTPUT_FILE = f"../nyt29/model_gen_anchor_{RULE_TYPE}_rules_with_support_pphrased_2.jsonl"
...
for i in tqdm(range(0, len(data), BATCH_SIZE)):
    ...
    for data_point in batch_data:
        ...
        for pphrase in test_pphrases.get(relation + "#" + doc_id.strip('"'), []):
    ...
    for idx, output in enumerate(primary_outputs):
        ...
        pphrases = test_pphrases.get(support["relation"] + "#" + support["sentence"]["id"].strip('"'), [])
